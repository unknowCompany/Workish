...
const Team: React.FC = () => {
  ...
  return (
    <section id="team" className="py-20 md:py-40 px-4 md:px-6 bg-gradient-to-b from-gray-800 via-gray-900 to-black relative overflow-hidden">
      {/* Enhanced Background Elements with Parallax */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Main gradient orbs with parallax */}
        <div className="absolute top-1/4 left-1/4 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse parallax-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000 parallax-medium"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-gradient-to-br from-purple-500/8 to-pink-500/8 rounded-full blur-3xl animate-pulse delay-500 parallax-fast"></div>
        
        {/* Additional floating elements with parallax */}
        <div className="absolute top-1/3 right-1/4 w-[150px] h-[150px] md:w-[300px] md:h-[300px] bg-gradient-to-br from-emerald-500/8 to-teal-500/8 rounded-full blur-3xl animate-pulse delay-1500 parallax-slow"></div>
        <div className="absolute bottom-1/3 left-1/3 w-[120px] h-[120px] md:w-[250px] md:h-[250px] bg-gradient-to-br from-orange-500/8 to-red-500/8 rounded-full blur-3xl animate-pulse delay-2000 parallax-medium"></div>
        
        {/* Floating particles with different sizes and colors and parallax */}
        ...
        <div className="absolute bottom-20 right-20 w-1.5 h-1.5 bg-pink-400 rounded-full animate-float delay-3000 opacity-50 shadow-lg shadow-pink-400/50 parallax-fast"></div>
        <div className="absolute top-1/2 left-10 w-1 h-1 bg-emerald-400 rounded-full animate-float delay-500 opacity-40 shadow-lg shadow-emerald-400/50 parallax-medium"></div>
        <div className="absolute top-1/3 right-10 w-2 h-2 bg-orange-400 rounded-full animate-float delay-1500 opacity-60 shadow-lg shadow-orange-400/50 parallax-slow"></div>
        
        {/* Animated lines with parallax */}
        <div className="absolute top-1/4 left-1/2 w-px h-32 bg-gradient-to-b from-transparent via-cyan-400/30 to-transparent animate-pulse parallax-medium"></div>
        <div className="absolute bottom-1/4 right-1/3 w-px h-24 bg-gradient-to-b from-transparent via-blue-400/30 to-transparent animate-pulse delay-1000 parallax-slow"></div>
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="grid grid-cols-6 md:grid-cols-8 gap-2 md:gap-4 h-full">
          {Array.from({ length: 48 }).map((_, i) => (
            <div key={i} className="border-t border-cyan-500/30 h-16 md:h-24 rounded-sm"></div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 md:mb-32 animate-fade-in-up">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl xl:text-8xl font-black text-white mb-4 md:mb-10 leading-tight">
          ...
          <p className="text-lg md:text-2xl lg:text-3xl text-gray-300 max-w-4xl md:max-w-5xl mx-auto leading-relaxed mb-6 md:mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-4 md:space-x-8 mt-8 md:mt-12">
              <div className="flex items-center space-x-2 text-cyan-400">
                ...
                <span className="text-sm md:text-lg font-semibold">6 Experts</span>
              </div>
              <div className="hidden sm:block w-px h-6 bg-gray-600"></div>
              <div className="flex items-center space-x-2 text-blue-400">
                <Award size={18} className="md:w-6 md:h-6" />
                <span className="text-sm md:text-lg font-semibold">50+ Years Combined</span>
              </div>
              <div className="hidden sm:block w-px h-6 bg-gray-600"></div>
              <div className="flex items-center space-x-2 text-purple-400">
                <Zap size={18} className="md:w-6 md:h-6" />
                <span className="text-sm md:text-lg font-semibold">100+ Projects</span>
              </div>
            </div>
          
          <div className="flex justify-center items-center mt-6 md:mt-8 space-x-2 md:space-x-4">
            <div className="w-12 md:w-20 h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent"></div>
            <div className="w-2 md:w-3 h-2 md:h-3 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full animate-pulse"></div>
            <div className="w-12 md:w-20 h-px bg-gradient-to-r from-transparent via-pink-400 to-transparent"></div>
          </div>
        </div>
          ...
          {teamMembers.map((member, index) => (
              ...
              <div className="glass-card p-6 md:p-10 rounded-2xl md:rounded-3xl group-hover:scale-105 transition-all duration-700 animate-fade-in-up relative overflow-hidden h-full">
                ...
                <div className="text-center mb-8 relative z-10">
                  <h3 className="text-lg md:text-2xl font-bold text-white mb-3 md:mb-4 group-hover:text-cyan-400 transition-colors duration-300">
                    {member.name}
                  </h3>
                  
                  {/* Role Badge */}
                  <div className="inline-block px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-cyan-400/10 via-blue-400/10 to-purple-400/10 rounded-full border border-cyan-400/20 mb-4 md:mb-6 backdrop-blur-sm">
                  ...
                  <div className="flex flex-wrap justify-center gap-1 md:gap-2 mb-4 md:mb-6">
                    {member.expertise.map((skill, skillIndex) => (
                      <span 
                        key={skillIndex}
                        className="px-2 md:px-3 py-1 bg-gradient-to-r from-gray-700/50 to-gray-600/50 rounded-full text-xs text-gray-300 border border-gray-600/30 backdrop-blur-sm"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div className="flex justify-center space-x-3 md:space-x-4 relative z-10">
                  {member.social.portfolio && (
                    <a 
                      href={member.social.portfolio}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 md:w-14 md:h-14 glass-card rounded-xl md:rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 group/social hover:bg-gradient-to-r hover:from-cyan-400/20 hover:to-blue-400/20 hover:border-cyan-400/30"
                    >
                                              <Link size={18} className="text-gray-400 group-hover/social:text-cyan-400 transition-colors duration-300 md:w-5.5 md:h-5.5" />
                    </a>
                  )}
                  {member.social.github && (
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 md:w-14 md:h-14 glass-card rounded-xl md:rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 group/social hover:bg-gradient-to-r hover:from-blue-400/20 hover:to-purple-400/20 hover:border-blue-400/30"
                    >
                                              <Github size={18} className="text-gray-400 group-hover/social:text-blue-400 transition-colors duration-300 md:w-5.5 md:h-5.5" />
                    </a>
                  )}
                  {member.social.linkedin && (
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 md:w-14 md:h-14 glass-card rounded-xl md:rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 group/social hover:bg-gradient-to-r hover:from-purple-400/20 hover:to-pink-400/20 hover:border-purple-400/30"
                    >
                                              <Linkedin size={18} className="text-gray-400 group-hover/social:text-purple-400 transition-colors duration-300 md:w-5.5 md:h-5.5" />
                    </a>
                  )}
                </div>
              </div>
        ...
        <div className="mt-20 md:mt-40 text-center animate-fade-in-up">
          <div className="glass-card p-8 md:p-16 rounded-2xl md:rounded-3xl max-w-4xl mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {/* Stats */}
              <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-8 mb-8 md:mb-10">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-cyan-400 mb-1 md:mb-2">15+</div>
                ...
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-blue-400 mb-1 md:mb-2">100%</div>
                  <div className="text-gray-400 text-xs md:text-sm">Remote Friendly</div>
                </div>
                <div className="hidden sm:block w-px h-8 md:h-12 bg-gray-600"></div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-purple-400 mb-1 md:mb-2">24/7</div>
              ...
              <button className="btn-primary text-base md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-2xl md:rounded-3xl hover:scale-105 transition-transform duration-300 shadow-2xl shadow-cyan-400/25">
                <Heart size={20} className="mr-2 md:mr-3 md:w-6 md:h-6" />
                View Open Positions
              </button>
            </div>
          </div>
