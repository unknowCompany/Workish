  ...
  return (
    <section id="team" className="py-20 md:py-40 px-4 md:px-6 bg-gradient-to-b from-gray-800 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Main gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div className="absolute top-1/3 right-1/4 w-[150px] h-[150px] md:w-[300px] md:h-[300px] bg-gradient-to-br from-emerald-500/8 to-teal-500/8 rounded-full blur-3xl animate-pulse delay-1500"></div>
        <div className="absolute bottom-1/3 left-1/3 w-[120px] h-[120px] md:w-[250px] md:h-[250px] bg-gradient-to-br from-orange-500/8 to-red-500/8 rounded-full blur-3xl animate-pulse delay-2000"></div>
