  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-gray-800">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Main gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-gradient-to-br from-cyan-500/10 to-indigo-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-3/4 left-1/2 w-[250px] h-[250px] bg-gradient-to-br from-indigo-500/8 to-purple-500/8 rounded-full blur-3xl animate-pulse delay-2000"></div>
        
        {/* Additional floating elements */}
        <div className="absolute top-1/3 right-1/3 w-[200px] h-[200px] bg-gradient-to-br from-emerald-500/6 to-teal-500/6 rounded-full blur-3xl animate-pulse delay-1500"></div>
        <div className="absolute bottom-1/3 left-1/4 w-[180px] h-[180px] bg-gradient-to-br from-orange-500/6 to-red-500/6 rounded-full blur-3xl animate-pulse delay-3000"></div>
      ...
      <div className="absolute inset-0 opacity-8">
        <div className="grid grid-cols-12 gap-4 h-full transform translate-y-8 parallax-slow">
          {Array.from({ length: 144 }).map((_, i) => (
            <div key={i} className="border border-cyan-500/15 h-20 rounded-sm"></div>
          ))}
        </div>
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        <div className="glass-card p-12 md:p-16 rounded-3xl animate-fade-in relative overflow-hidden">
          {/* Background gradient */}
          ...
          <div className="relative z-10">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight">
              The Future of Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 via-purple-400 to-pink-400 animate-pulse block mt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <button className="btn-primary group text-lg px-10 py-4 rounded-2xl hover:scale-105 transition-transform duration-300 shadow-xl shadow-cyan-400/20">
                <Sparkles className="mr-2" size={20} />
                Request Demo
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform duration-300" size={20} />
              </button>
              
              <button className="btn-secondary group text-lg px-10 py-4 rounded-2xl hover:scale-105 transition-transform duration-300">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white/60">
        <div className="flex flex-col items-center">
          ...
          <div className="w-px h-12 bg-gradient-to-b from-cyan-400 via-blue-400 to-transparent animate-pulse"></div>
