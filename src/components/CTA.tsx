...
const CTA: React.FC = () => {
  ...
  return (
    <section id="cta" className="py-40 px-6 bg-gradient-to-b from-black via-gray-900 to-gray-800 relative overflow-hidden">
      {/* Enhanced Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Main gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-blue-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-gradient-to-br from-pink-500/10 to-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-cyan-500/8 to-purple-500/8 rounded-full blur-3xl animate-pulse delay-500"></div>
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        {/* Enhanced Main CTA */}
        <div className="glass-card p-16 md:p-20 rounded-3xl animate-fade-in relative overflow-hidden mb-32">
          {/* Background gradient */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
              <button className="btn-primary group text-xl px-12 py-6 rounded-3xl hover:scale-105 transition-transform duration-300 shadow-2xl shadow-cyan-400/25">
                <Calendar className="mr-3 group-hover:scale-110 transition-transform duration-300" size={24} />
                Schedule Demo
                <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform duration-300" size={24} />
              </button>
              
              <button className="btn-secondary group text-xl px-12 py-6 rounded-3xl hover:scale-105 transition-transform duration-300">
                <MessageSquare className="mr-3 group-hover:scale-110 transition-transform duration-300" size={24} />
                Contact Sales
              </button>
            </div>
