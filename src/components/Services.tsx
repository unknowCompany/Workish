  ...
  return (
    <section id="services" className="py-20 md:py-40 px-4 md:px-6 bg-gradient-to-b from-gray-800 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 right-20 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse parallax-slow"></div>
        <div className="absolute bottom-20 left-20 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000 parallax-medium"></div>
        ...
        <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] bg-gradient-to-br from-emerald-500/8 to-teal-500/8 rounded-full blur-3xl animate-pulse delay-1500 parallax-slow"></div>
        <div className="absolute bottom-1/3 right-1/4 w-[250px] h-[250px] bg-gradient-to-br from-orange-500/8 to-red-500/8 rounded-full blur-3xl animate-pulse delay-2000 parallax-medium"></div>
        
        {/* Floating particles with parallax */}
        <div className="absolute top-32 left-32 w-3 h-3 bg-cyan-400 rounded-full animate-float opacity-70 shadow-lg shadow-cyan-400/50 parallax-fast"></div>
        <div className="absolute top-48 right-40 w-2 h-2 bg-blue-400 rounded-full animate-float delay-1000 opacity-60 shadow-lg shadow-blue-400/50 parallax-medium"></div>
        <div className="absolute bottom-40 left-1/3 w-2.5 h-2.5 bg-purple-400 rounded-full animate-float delay-2000 opacity-80 shadow-lg shadow-purple-400/50 parallax-slow"></div>
        <div className="absolute bottom-32 right-32 w-1.5 h-1.5 bg-pink-400 rounded-full animate-float delay-3000 opacity-50 shadow-lg shadow-pink-400/50 parallax-fast"></div>
